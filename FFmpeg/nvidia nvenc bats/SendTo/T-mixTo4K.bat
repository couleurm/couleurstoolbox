ffmpeg -hwaccel cuda -i %1 -vf tmix=frames=8:weights="1",fps=60,hwupload_cuda,scale_cuda=3840:2160:1 -c:v hevc_nvenc -preset p7 -rc constqp -qp 18 -c:a copy "%~dpn1 (Resampled).mp4
pause
